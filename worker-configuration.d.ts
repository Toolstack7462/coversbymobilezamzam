/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9adab668bea7c863693cfdd1bae09c9d)
// Runtime types generated with workerd@1.20260828.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	PRIVATE_FILES: R2Bucket;
	DB: D1Database;
	APP_ENV: "preview" | "development" | "staging" | "production";
	APP_BASE_URL: "https://italian-tech-atelier-commerce-preview.genzdigitaltools7462.workers.dev" | "http://localhost:5173" | "https://REPLACE_WITH_STAGING_ORIGIN" | "https://REPLACE_WITH_PRODUCTION_ORIGIN";
	DEFAULT_LOCALE: "it";
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		DB: D1Database;
		APP_ENV: "preview";
		APP_BASE_URL: "https://italian-tech-atelier-commerce-preview.genzdigitaltools7462.workers.dev";
		DEFAULT_LOCALE: "it";
		SUPPORTED_LOCALES: "it,en";
		DEFAULT_CURRENCY: "EUR";
		STORE_TIMEZONE: "Europe/Rome";
	}
	interface RestoreTestEnv {
		MEDIA: R2Bucket;
		PRIVATE_FILES: R2Bucket;
		DB: D1Database;
		APP_ENV: "development";
	...
	interface StagingEnv {
		...
		DB: D1Database;
		APP_ENV: "staging";
		APP_BASE_URL: "https://REPLACE_WITH_STAGING_ORIGIN";
		DEFAULT_LOCALE: "it";
		SUPPORTED_LOCALES: "it,en";
		DEFAULT_CURRENCY: "EUR";
		STORE_TIMEZONE: "Europe/Rome";
	...
	interface ProductionEnv {
		...
		DB: D1Database;
		APP_ENV: "production";
		APP_BASE_URL: "https://REPLACE_WITH_PRODUCTION_ORIGIN";
		DEFAULT_LOCALE: "it";
		SUPPORTED_LOCALES: "it,en";
		DEFAULT_CURRENCY: "EUR";
		STORE_TIMEZONE: "Europe/Rome";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_BASE_URL" | "DEFAULT_LOCALE" | "SUPPORTED_LOCALES" | "DEFAULT_CURRENCY" | "STORE_TIMEZONE">> {}
}
